/* oxlint-disable next/no-html-link-for-pages -- Native navigation avoids the confirmed Vinext production Link error. */
'use client';
...
export default function MatchGame() {
  ...
  function tap(id: number) {
    if (!loaded || help || feedbackOpen) return;
    ...
    <main className={`match-app ${reduced ? 'reduce-motion' : ''}`}>
      ...
      <div className="match-layout">
        <aside className="match-intro">
          ...
          <a className="match-baseline" href="/">
